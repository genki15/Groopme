...
SWIFT_CLASS("_TtC7Groopme11AppDelegate")
...
SWIFT_CLASS("_TtC7Groopme14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * __null_unspecified usernameText;
@property (nonatomic, strong) IBOutlet UITextField * __null_unspecified passwordText;
