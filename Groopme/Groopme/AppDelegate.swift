...
<<<<<<< HEAD
        ...
        query.getObjectInBackgroundWithId("I0LqhDZZE6") {
            (gameScore: PFObject?, error: NSError?) -> Void in
            if error == nil && gameScore != nil {
                print(gameScore!["number"])
            } else {
                print(error)
            }
        }*/
...
>>>>>>> 8c07daac0d375b7f11c98212acf817e0a1c46c61
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "GreenArrow.Groopme" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Groopme", withExtension: "momd")!
